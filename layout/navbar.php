...
<nav class="navbar navbar-expand-lg bg-body-tertiary sticky-top" id="navId">
        ...
        <div class="offcanvas offcanvas-end" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel" style="height: 100% !important;">
            <div class="d-flex flex-column flex-sm-column flex-md-row flex-lg-row justify-content-end h-100" role="search">
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link px-3" href="#quienes-somos">¿Quiénes somos?</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link px-3" href="#sobre-nosotros">Sobre nosotros</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link px-3" href="#nuestros-servicios">Nuestros servicios</a>
                    </li>
                    <li class="nav-item">
